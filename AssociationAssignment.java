public class AssociationAssignment {
	public static void main(String[] args) {
		...
		Flat flat1= new Flat("Rohan Tapovan","SB Road",200,101,"B",1150.0f,1);
		Room r1= new Room("Rohan Tapovan","SB Road",200,101,"B",1150.0f,1, 2, 750, "Cyan");
		Washroom w = new Washroom("Common washroom", true);
		Bed b = new Bed("Bunk-bed", "7*3 ft", "Black");
		s1.printSociety();
	
		flat1.createRoom(800, w, b);
		Flat flat2= new Flat("Rohan Tapovan","SB Road",200,901,"B",1150.0f,5);
		flat2.createRoom(1000, w, b);
			
	}
	
	
}
class Society extends RuntimeException
{
	String societyName;
	String address;
	int  nOfFlats;
...
class Flat extends Society
{
	...
	{	
		...
		if(flatNo>200) {
			throw new RuntimeException("Enter correct flat no. ");
		}
		else {
		...
		System.out.println("The flat has a : "+w.type +" and it is fitted with solar heater "+w.solarHeater);
