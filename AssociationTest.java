...
public class AssociationTest 
{
		...
		public static void main(String[] args) {
			...
			panCard1.setPanCard("BANPL07778S", "Janet Dsouza", "Robert Dsouza", LocalDate.of(2002, 12, 25));
			panCard2.setPanCard("MANPL00822Q", "Robert Dmello", "Peter Dmello", LocalDate.of(2003, 11, 20));
			panCard3.setPanCard("PLNPL08383T", "Julia Pareira", "Smith Pareira", LocalDate.of(2004, 10, 21));
...
//			System.out.println("the person : "+thePersonObj);
			...
			Student theStudentObj = new Student('M', "Robert", 24, aadharCard2,panCard2, "Bits Pilani", "MBA", 'A');
...
//			System.out.println("the student "+theStudentObj);
			...
			Employee empObj = new Employee('F', "Julie", 22, aadharCard3,panCard3, "IIT", "Mtech", 'A', "Google", "Analyst", 25000);
	...
	class PanCard
	{
		...
		String fathersName;
		LocalDate doBDate;
		public void setPanCard(String panNumber, String nameOnPancard, String fathersName, LocalDate doBDate) {
		...
		void printPanCard()
		{
				...
				System.out.println("PAN Card Name : "+nameOnPancard);
				System.out.println("Father's Name : "+fathersName);
				System.out.println("Birthdate     : "+doBDate);
		}
